...
export default function Home() {
  return (
    <div className="flex items-center justify-center font-sans bg-teal-950 ">
      <main className="flex min-h-screen w-full flex-col items-center justify-between sm:items-start">
        ...
        <div style={{"backgroundColor": "#ebe2cf" }} className="w-full h-full justify-items-center justify-center text-center pb-6">
          <div className="sm:w-[85%] lg:w-[60%]">
            <div className="text-5xl text-black font-semibold pt-2 transition delay-150 duration-300 ease-in">My Work</div>
